...
import com.vension.frame.views.simplifyspan.SimplifySpanBuild;
import com.vension.frame.views.simplifyspan.other.OnClickableSpanListener;
import com.vension.frame.views.simplifyspan.other.SpecialConvertMode;
import com.vension.frame.views.simplifyspan.other.SpecialGravity;
import com.vension.frame.views.simplifyspan.unit.SpecialClickableUnit;
import com.vension.frame.views.simplifyspan.unit.SpecialImageUnit;
import com.vension.frame.views.simplifyspan.unit.SpecialLabelUnit;
import com.vension.frame.views.simplifyspan.unit.SpecialTextUnit;
...
public class SimplifySpanFragment extends BaseCustomViewFragment implements OnClickableSpanListener {
	...
	TextView tvText4;
	@BindView(R.id.tv_text41)
	TextView tvText41;

	@Override
	public int attachLayoutRes() {
		return R.layout.fragment_test_simplify_spantext;
	}
...
//        tvText1.setText(new SimplifySpanBuild("距离您：").append(new SpecialTextUnit("385", Color.BLUE)).append(" 米").build());
		...
		simplifySpanBuild11.append(new SpecialLabelUnit("火", Color.RED, sp2px(7), BitmapFactory.decodeResource(getResources(), R.drawable.ic_default_1)).setPadding(15).setGravity(SpecialGravity.CENTER))
				.append("正常")
				.append(new SpecialLabelUnit("火", Color.RED, sp2px(7), BitmapFactory.decodeResource(getResources(), R.drawable.ic_default_1)).setPadding(15).setGravity(SpecialGravity.TOP))
				.append("正常")
				.append(new SpecialLabelUnit("火", Color.RED, sp2px(7), BitmapFactory.decodeResource(getResources(), R.drawable.ic_default_1)).setPadding(15).setGravity(SpecialGravity.BOTTOM))
				.append("正常")
				.append(new SpecialLabelUnit("原创", Color.BLACK, sp2px(10), BitmapFactory.decodeResource(getResources(), R.drawable.ic_default_1)).setPadding(5).setPaddingLeft(15).setPaddingRight(30).setGravity(SpecialGravity.TOP))
				.append("正常")
				.append(new SpecialLabelUnit("原创", Color.BLACK, sp2px(10), BitmapFactory.decodeResource(getResources(), R.drawable.ic_default_1)).setPadding(5).setPaddingLeft(15).setPaddingRight(30).setGravity(SpecialGravity.CENTER))
				.append("正常")
				.append(new SpecialLabelUnit("原创", Color.BLACK, sp2px(10), BitmapFactory.decodeResource(getResources(), R.drawable.ic_default_1)).setPadding(5).setPaddingLeft(15).setPaddingRight(30).setGravity(SpecialGravity.BOTTOM))
				.append("正常")
		...
		simplifySpanBuild3.append(new SpecialImageUnit(getActivity(), BitmapFactory.decodeResource(getResources(), R.drawable.ic_default_1), 50, 50).setGravity(SpecialGravity.CENTER))
				.append("正常")
				.append(new SpecialImageUnit(getActivity(), BitmapFactory.decodeResource(getResources(), R.drawable.ic_default_1), 150, 150))
				.append("正常")
				.append(new SpecialImageUnit(getActivity(), BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher), 50, 50).setGravity(SpecialGravity.CENTER))
				.append("正常")
				.append(new SpecialImageUnit(getActivity(), BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher), 50, 50).setGravity(SpecialGravity.TOP))
				.append("正常")
				.append(new SpecialImageUnit(getActivity(), BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher), 50, 50).setGravity(SpecialGravity.BOTTOM));
		...
		simplifySpanBuild4.appendMultiClickable(new SpecialClickableUnit(tvText4, this).setNormalTextColor(linkNorTextColor).setPressBgColor(linkPressBgColor),
				" ",
				new SpecialImageUnit(getActivity(), BitmapFactory.decodeResource(getResources(), R.drawable.ic_default_1), 35, 35).setGravity(SpecialGravity.CENTER),
				new SpecialTextUnit("LOL新大战闻声识英雄 "));
		simplifySpanBuild4.append("完整文章见 ");
		simplifySpanBuild4.appendMultiClickable(new SpecialClickableUnit(tvText4, this).setNormalTextColor(linkNorTextColor).setPressBgColor(linkPressBgColor),
				new SpecialImageUnit(getActivity(), BitmapFactory.decodeResource(getResources(), R.drawable.ic_default_1), 30, 30).setGravity(SpecialGravity.CENTER),
				new SpecialTextUnit("LOL超强攻略,不见绝对后悔 "));
		simplifySpanBuild4.append(" 更多好玩的内容请点击 ");
		simplifySpanBuild4.appendMultiClickable(new SpecialClickableUnit(tvText4, this).setNormalTextColor(linkNorTextColor).setPressBgColor(linkPressBgColor),
				new SpecialImageUnit(getActivity(), BitmapFactory.decodeResource(getResources(), R.drawable.ic_default_1), 42, 42).setGravity(SpecialGravity.CENTER),
	...
	public void onClick(TextView tv, String clickText) {
		VToastUtil.showToast("Click Text: " + clickText);
	}
