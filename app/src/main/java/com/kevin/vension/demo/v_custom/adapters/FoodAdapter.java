...
public class FoodAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_test_food, null);
        ...
        GlideImageLoader.create(viewHolder.iv_goods_fits_picture).loadLocalImage(models.get(position).getPath(), R.color.placeholder_color);
