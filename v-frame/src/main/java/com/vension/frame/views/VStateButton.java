 ...
 */
public class VStateButton extends AppCompatTextView {
    //text color
    ...
    public VStateButton(Context context) {
        this(context, null);
    }

    public VStateButton(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.buttonStyle);
    }

    public VStateButton(Context context, AttributeSet attrs, int defStyleAttr) {
