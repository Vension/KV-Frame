...
public final class ActivityUtil {
    ...
    public static Activity getTopActivity() {
        if (VFrame._TopActivityWeakRef != null) {
            Activity activity = VFrame._TopActivityWeakRef.get();
            if (activity != null) {
                return activity;
            }
        }
        List<Activity> activities = VFrame._ActivityList;
