package com.vension.frame.adapters.recy.decoration;
 ...
 * @use
 *      val mItemDecoration = RecGridDividerItemDecoration(GridLayoutManager(getActivity(), 3) as GridLayoutManager, 5, true)
