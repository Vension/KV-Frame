package com.vension.customview.shapeloadingview;
        ...
        switch (mShape) {
            case SHAPE_TRIANGLE:
                if (mIsLoading) {
                    ...
                    @SuppressLint("RestrictedApi") int color= (int) mArgbEvaluator.evaluate(mAnimPercent,mTriangleColor,mCircleColor);
            ...
            case SHAPE_CIRCLE:
                if (mIsLoading) {
                    ...
                    @SuppressLint("RestrictedApi") int color= (int) mArgbEvaluator.evaluate(mAnimPercent,mCircleColor,mRectColor);
                    mPaint.setColor(color);
            ...
            case SHAPE_RECT:
                if (mIsLoading) {
                    ...
                    @SuppressLint("RestrictedApi") int color= (int) mArgbEvaluator.evaluate(mAnimPercent,mRectColor,mTriangleColor);
                    mPaint.setColor(color);
                    Path path = new Path();
