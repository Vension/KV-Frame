...
public class RingView extends View {
    ...
    private int sWidthringPaint = 0;//外层弧线的宽度
    private int sWidthprogerssPaint = 0;//内层弧形的大小
    private int textPaintSize = 0;//弧形上文本的大小
    private int progerssPaintSize = 0;//进度值的文本大小
    private int pointShadowLayer = 0;
    private int pointPaintSize = 0;//移动小圆点的大小
...
//        setBackgroundColor(getResources().getColor(android.R.color.transparent));
        ...
        textPaintSize = dip2px(getContext(), 12f);
        sWidthringPaint = dip2px(getContext(), 1.5f);
        sWidthprogerssPaint = dip2px(getContext(), 14.0f);
        pointPaintSize = dip2px(getContext(), 2.0f);
        pointShadowLayer = dip2px(getContext(), 12.0f);
