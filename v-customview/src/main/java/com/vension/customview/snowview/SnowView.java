package com.vension.customview.snowview;
...
public class SnowView extends View {
    public static final int SNOW_LEVEL_SMALL = 1;//小雪
    public static final int SNOW_LEVEL_MIDDLE = 2;//中雪
    public static final int SNOW_LEVEL_HEAVY = 3;//大雪
...
//    }
    ...
    private void initSnowFlakes(){
        mSnowDrawable = getResources().getDrawable(R.drawable.snow);
//        mSnowDrawable = getResources().getDrawable(R.drawable.snow, getContext().getTheme());
        mSnowBitmap = ((BitmapDrawable)(getResources().getDrawable(R.drawable.snow))).getBitmap();
    ...
    private void produceSnowFlake(){
        ...
        for(int i = 0; i < mSnowFlakeList.size(); i++){
            ...
            if(!snow.isLive){
                ...
                snow.x = mRandom.nextInt((mWidth - edge * 2) > 0 ? (mWidth - edge * 2) : 20) + edge;
                snow.y = -edge;
                snow.startX = snow.x;
                snow.startY = snow.y;
