package com.vension.customview.passcodeview;
...
import static com.vension.customview.passcodeview.PasscodeView.PasscodeViewType.TYPE_CHECK_PASSCODE;
import static com.vension.customview.passcodeview.PasscodeView.PasscodeViewType.TYPE_SET_PASSCODE;
...
public class PasscodeView extends FrameLayout implements View.OnClickListener {
    ...
    public PasscodeView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        try {
            ...
            normalStatusColor = typedArray.getColor(R.styleable.PasscodeView_normalStateColor_pcv, normalStatusColor);
            wrongStatusColor = typedArray.getColor(R.styleable.PasscodeView_wrongStateColor_pcv, wrongStatusColor);
            correctStatusColor = typedArray.getColor(R.styleable.PasscodeView_correctStateColor_pcv, correctStatusColor);
