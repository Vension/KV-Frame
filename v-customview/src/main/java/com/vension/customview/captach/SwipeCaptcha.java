package com.vension.customview.captach;
...
public class SwipeCaptcha extends android.support.v7.widget.AppCompatImageView {
    private final String TAG = SwipeCaptcha.class.getName();
    //控件的宽高
...
// 应用mask
    ...
    public interface OnCaptchaMatchCallback {
        void matchSuccess(SwipeCaptcha SwipeCaptcha);

        void matchFailed(SwipeCaptcha SwipeCaptcha);
    }
