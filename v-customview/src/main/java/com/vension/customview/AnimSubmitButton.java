 ...
 */
public class AnimSubmitButton extends AppCompatTextView {
    ...
    public AnimSubmitButton(Context context) {
        super(context);
        init(null);
    }

    public AnimSubmitButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public AnimSubmitButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    void init(AttributeSet attrs) {
        ...
        TypedArray typeArray = getContext().obtainStyledAttributes(attrs, R.styleable.SubmitButton);
