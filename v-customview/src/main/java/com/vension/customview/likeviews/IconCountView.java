package com.vension.customview.likeviews;
 ...
 * @use  praiseView.setCount(Long.valueOf(editText.getText().toString()));
 */
...
public class IconCountView extends LinearLayout {
    ...
    public IconCountView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int normalRes = a.getResourceId(R.styleable.IconCountView_normalRes, R.mipmap.icon_praise_normal);
        int selectedRes = a.getResourceId(R.styleable.IconCountView_selectedRes, R.mipmap.icon_praise_selected);
        long count = a.getInt(R.styleable.IconCountView_count, 0);
        String zeroText = a.getString(R.styleable.IconCountView_zeroText);
        int textNormalColor = a.getColor(R.styleable.IconCountView_textNormalColor, getResources().getColor(R.color.gray));
        int textSelectedColor = a.getColor(R.styleable.IconCountView_textSelectedColor, getResources().getColor(R.color.gray));
