...
import com.vension.customview.galleryanimations.math.BezierStar;
import com.vension.customview.galleryanimations.particle.model.Point;
import com.vension.customview.galleryanimations.particle.model.Star;
...
public class TaijiStarPath implements IEffect {
    ...
    private void drawAnimationText(int frame, Canvas canvas, Paint paint) {
        ...
        String title = "Kevin~Vension";
        String content = "Gallery~Animations";
        paint.reset();
