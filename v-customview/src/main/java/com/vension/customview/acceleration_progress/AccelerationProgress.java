...
public class AccelerationProgress extends View implements LinearAnimation.LinearAnimationListener {
    ...
    public AccelerationProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDuration = a.getInt(R.styleable.AccelerationProgress_acc_duration, DEFAULT_DURATION);
        mTimeTextSize = a.getDimensionPixelSize(R.styleable.AccelerationProgress_time_TextSize, 20);
        a.recycle();
        init();
    }
