package com.vension.customview.alphaView;
...
public class AlphaView extends View {
    ...
    private int mTextColorSelected = 0xFF00BCD4;  //述文本的默认选中显示颜色
//    private int mTextColorSelected = 0xFF46C01B;  //述文本的默认选中显示颜色(微信色)
